...
class ChefDetailViewController: UIViewController, UITabBarDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        mealsTableView.layoutIfNeeded()
        mealsTableViewHeightConstraint.constant = mealsTableView.contentSize.height
